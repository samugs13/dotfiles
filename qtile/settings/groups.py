...
__groups = {
        ...
        3: Group(name=fa.icons['edit'], layout='monadtall'),
        4: Group(name=fa.icons['code'], layout='monadtall'),
        5: Group(name=fa.icons['tv'], layout='max'),
        6: Group(name=fa.icons['folder-open'], layout='monadwide'),
        7: Group(name=fa.icons['video'], layout='max'),
        8: Group(name=fa.icons['music'], layout='max'),
        9: Group(name=fa.icons['comment-dots'], layout='max'),
        0: Group(name=fa.icons['envelope'], layout='max'),
}
