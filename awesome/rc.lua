...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,}, "a", function () mymainmenu:show() end, {description = "show main menu", group = "awesome"}),
    awful.key({ modkey,}, "p", hotkeys_popup.show_help, {description="show help", group="awesome"}),
    ...
    -- Media keys
    awful.key({ }, "Print", function () awful.util.spawn("flameshot gui") end, {description = "print screen", group = "media"}),
    awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("brightnessctl set 5%+") end, {description = "increase brightness", group = "media"}),
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("brightnessctl set 5%-") end, {description = "decrease brightness", group = "media"}),
    awful.key({ }, "XF86AudioPlay", function () awful.util.spawn("playerctl play-pause") end, {description = "play/pause audio", group = "media"}),
    awful.key({ }, "XF86AudioNext", function () awful.util.spawn("playerctl next") end, {description = "next audio", group = "media"}),
    awful.key({ }, "XF86AudioPrev", function () awful.util.spawn("playerctl previous") end, {description = "previous audio", group = "media"}),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer sset Master playback 5%+") end, {description = "increase volume", group = "media"}),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer sset Master playback 5%-") end, {description = "decrease volume", group = "media"}),
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -q sset Master toggle") end, {description = "mute/unmute", group = "media"}), 
    
    -- Standard programs and scripts
    awful.key({ modkey,}, "F1", function () awful.util.spawn("sh /home/s4mb4/Escritorio/scripts/dmenu-togglescreenlayout.sh") end, {description = "modify screen layout", group = "launcher"}),
    awful.key({ modkey,}, "Return", function () awful.spawn(terminal) end, {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey,}, "b", function () awful.util.spawn("brave --new-window") end, {description = "open browser", group = "launcher"}),
    awful.key({ modkey,}, "d", function () awful.util.spawn("dolphin") end, {description = "open file manager", group = "launcher"}),
